...
import presidentialThemeLogo from "/assets/presidental theme.png";
      ...
      <section className="flex flex-col items-center text-center mt-24 px-6">
        ...
        <div className="mt-8 flex flex-col items-center gap-3">
          <p className="text-sm uppercase tracking-[0.2em] text-gray-400">
            Organized by Interact Club of Matribhumi Baluwatar
          </p>
          <div className="flex flex-wrap items-center justify-center gap-6">
            <img className="h-14 w-auto object-contain" src={mainLogo} alt="Interact Club of Matribhumi Baluwatar Logo" />
            <img className="h-14 w-auto object-contain" src={presidentialThemeLogo} alt="Presidential Theme Logo" />
          </div>
        </div>
   ...
   {/* MAIN CONTENT */}
        ...
        <section id="contact-section" className="mb-32">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <a href="https://instagram.com/bimsexpo" target="_blank" rel="noopener noreferrer" className="contact-card">
              ...
              <span className="contact-handle">@icmatribhumibaluwatar</span>
            </a>

            {/* WhatsApp */}
            <a href="https://wa.me/9824867410" target="_blank" rel="noopener noreferrer" className="contact-card">
              ...
              <span className="contact-handle">+977 982-4867410</span>
            </a>
            ...
            <a href="mailto:contact@bimsexpo.com" className="contact-card">
              ...
              <span className="contact-handle">int.matribhumibaluwatar@gmail.com</span>
            </a>
          </div>
        </section>
      ...
      <footer className="py-10 text-center border-t border-white/5 bg-slate-950">
        <div className="flex flex-wrap justify-center items-center gap-4 mb-4">
          ...
          <img className="h-10 w-auto grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all" src={mainLogo} alt="Interact Club of Matribhumi Baluwatar Logo" />
          <img className="h-10 w-auto grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all" src={presidentialThemeLogo} alt="Presidential Theme Logo" />
        </div>
      ...
      <a
        href="https://icmatribhumibaluwatar.org/"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-[60] rounded-full bg-cyan-400 px-5 py-3 text-sm font-semibold text-black shadow-lg shadow-cyan-500/30 transition hover:bg-cyan-300"
